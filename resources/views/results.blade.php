                ...
                @foreach($vendors as $vendor)
                    <div class="listing-card row mb-4 p-3 shadow-sm align-items-center bg-white rounded">
                        ...
                        <div class="col-md-3 d-flex flex-column align-items-end">
                            ...
                            <a href="{{ route('chat', ['vendorId' => $vendor->user->id]) }}" class="btn btn-outline-danger btn-sm w-100 d-flex align-items-center justify-content-center">Chat with {{ $vendor->business_name }}</a>
